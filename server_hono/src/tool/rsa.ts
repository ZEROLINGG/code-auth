...
export class RSA {
    ...
    static async encrypt(data: string | Uint8Array, publicKeyPem: string): Promise<string> {
    ...
    static async decrypt_ToString(encryptedB64: string, privateKeyPem: string): Promise<string> {
        const decrypted = await this.decrypt_ToUint8Array(encryptedB64, privateKeyPem);
        return new TextDecoder().decode(decrypted);
    }
    static async decrypt_ToUint8Array(encryptedB64: string, privateKeyPem: string): Promise<Uint8Array> {
